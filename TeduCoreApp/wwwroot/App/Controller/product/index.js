var productController = function () {
            ...
            function () {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        tedu.notify("Export excel successful :)", 'success');
                        tedu.stopLoading();
                    },
                    error: function() {
                        tedu.notify("Has an error in process", 'error');
                        tedu.stopLoading();
                    }
                });
            });
    ...
    function wrapPaging(recordCount, callBack, changePageSize) {
        var totalsize = Math.ceil(recordCount / tedu.config.pageSize);
