...
namespace TeduCoreApp.Areas.Admin.Controllers
{
    public class BillController : BaseController
    {
        ...
        [HttpGet]
        public IActionResult GetAllPaging(string startDate, string endDate, string keyword,
        ...
        {
            List<EnumModel> enums = ((BillStatus[]) Enum.GetValues(typeof(BillStatus))).Select(x => new EnumModel()
            {
                Value = (int)x,
